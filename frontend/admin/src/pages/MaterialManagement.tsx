...
const MaterialManagement: React.FC = () => {
  ...
  const handleUpload = async (values: any) => {
    try {
      ...
      setLoading(true);
      const response = await axios.post(`${API_BASE_URL}/api/materials/upload`, formData, {
        headers: {
  ...
  const handleEdit = async (values: any) => {
    ...
    try {
      setLoading(true);
      await axios.put(`${API_BASE_URL}/api/materials/${currentMaterial.id}`, {
        title: values.title,
    ...
    <div className="material-management-page">
      ...
      >
        ...
        <Tabs activeKey={activeTab} onChange={setActiveTab}>
          ...
          <TabPane tab="已下架" key="Unpublished" />
        </Tabs>
